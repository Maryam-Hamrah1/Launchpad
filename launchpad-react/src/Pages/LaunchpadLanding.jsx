...
const FORMSPREE_ENDPOINT = "https://formspree.io/f/mjgnnoyn";

const FEATURES = [
  {
    icon: Target,
    title: "Goal Creation",
    desc: "Set a goal in plain language — Launchpad structures it into a full plan.",
  },
  {
    icon: Bot,
    title: "AI Roadmap Generator",
    desc: "Get a milestone-by-milestone route built around your goal and level.",
  },
  {
    icon: BookOpen,
    title: "Learning Resources",
    desc: "Every milestone comes with vetted resources, so you never search alone.",
  },
  {
    icon: Calendar,
    title: "Daily Missions",
    desc: "Your roadmap breaks into daily tasks sized to fit a real schedule.",
  },
  {
    icon: TrendingUp,
    title: "Progress Tracking",
    desc: "See exactly how far along the route you are, and what's next.",
  },
  {
    icon: MessageCircle,
    title: "AI Coach",
    desc: "Ask questions, get unstuck, and adjust your plan as your goal evolves.",
  },
];
...
const AI_CAPABILITIES = [
  {
    icon: MessageCircle,
    title: "Ask Anytime",
    desc: "Get unstuck on any step without ever leaving your roadmap.",
  },
  {
    icon: Repeat,
    title: "Adapts With You",
    desc: "Change your pace or goal and your coach reshapes the plan instantly.",
  },
  {
    icon: Map,
    title: "Explains The Why",
    desc: "Understand not just what's next, but why it matters for your goal.",
  },
  {
    icon: Bot,
    title: "Learns Your Style",
    desc: "Suggestions get sharper the more it learns how you like to learn.",
  },
];
...
const STEPS = [
  {
    ...
    desc: "Tell Launchpad what you're aiming for — a career, a skill, a milestone.",
  },
  {
    icon: Bot,
    title: "AI Creates Your Roadmap",
    desc: "Launchpad plots a personalized route with milestones and resources.",
  },
  {
    icon: CheckCircle2,
    title: "Complete Daily Missions",
    desc: "Follow a manageable, day-by-day plan built around your pace.",
  },
  {
    icon: TrendingUp,
    title: "Track Your Progress",
    desc: "Watch your roadmap fill in as streaks and milestones add up.",
  },
  {
    icon: Trophy,
    title: "Achieve Your Goal",
    desc: "Arrive with a clear record of exactly how you got there.",
  },
];
...
const STORIES = [
  {
    initial: "H",
    name: "Hamesha",
    role: "Finished UX Roadmap",
    quote:
      "I finally finished the UX roadmap I'd been putting off for two years. Breaking it into daily steps made all the difference.",
  },
  {
    initial: "M",
    name: "Mahdia",
    ...
    quote:
      "Launchpad gave me a plan I could actually follow. Three months later I had my first freelance client.",
  },
  {
    initial: "S",
    name: "Samira",
    role: "Got First Job",
    quote:
      "Every milestone felt achievable instead of overwhelming. Got my first developer job right on schedule.",
  },
];

const FAQS = [
  {
    q: "How does Launchpad generate roadmaps?",
    a: "Launchpad's AI analyzes your goal, experience level, timeline, and study hours, then builds a month-by-month roadmap broken into daily missions.",
  },
  {
    q: "Can I edit my roadmap?",
    a: "Yes — you're never locked in. You can regenerate a month or adjust your goal at any time.",
  },
  {
    q: "Does AI recommend courses?",
    a: "Each milestone comes with curated learning resources matched to what that stage of your roadmap needs.",
  },
  {
    q: "Can I regenerate my roadmap?",
    a: "Yes — if your goal or pace changes, you can regenerate any month for an updated plan.",
  },
  {
    q: "Is my data secure?",
    a: "Your goals and progress are private to your account and never shared.",
  },
  {
    q: "Is Launchpad free?",
    a: "Launchpad offers a free tier to get started, with additional features on paid plans.",
  },
];
      ...
      <div className="flex">
        ...
        <div className="flex-1 p-3.5 sm:p-4 min-w-0">
          ...
          <div className="flex items-center gap-2 mb-3.5">
            ...
            <div
              className="w-7 flex items-center justify-center  text-[12px] h-7 rounded-lg flex-shrink-0"
              style={{
                background: "var(--color-bg)",
                border: "1px solid var(--color-line)",
              }}
          ...
          >
            <div className="flex justify-between items-start gap-3">
              <div className="min-w-0">
                ...
                <div className="text-[13px] font-bold display leading-tight flex items-center gap-1">
                  Good morning, Maryam 👋
                </div>
                <p
                  className="text-[9px] mt-1.5 leading-4"
                  style={{ color: "var(--color-ink-dim)" }}
                >
                  Track your goals, follow your AI roadmap, and keep moving
                  toward your future.
                </p>
              </div>
...
export default function LaunchpadLanding() {
  ...
  async function handleContactSubmit(e) {
    ...
    if (!FORMSPREE_ENDPOINT) {
      setContactError(
        "Contact form isn't connected yet — add your Formspree endpoint."
      );
      return;
    }
      ...
      >
        <div className="max-w-6xl mx-auto flex items-center justify-between px-6 md:px-8 py-4">
          ...
          <div className="flex items-center gap-3">
            <Link
              to="/login"
              className="hidden sm:inline-flex btn-ghost rounded-full px-5 py-2.5 text-sm font-semibold"
            >
              Log in
            </Link>
            <Link
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-8 grid md:grid-cols-2 gap-10 md:gap-14 items-center relative">
          <Reveal>
            ...
            <p
              ...
              style={{ color: "var(--color-ink-dim)" }}
            >
              Launchpad analyzes your goal, experience, available time, and
              preferred learning style to generate a step-by-step roadmap with
              milestones, curated resources, and progress tracking — all powered
              by AI.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-9">
              <Link
                to="/signUp"
                className="btn-solid rounded-full px-6 py-3.5 text-sm font-semibold text-center"
              >
                Create Free Roadmap
              </Link>
              <a
                href="#how"
                className="btn-ghost rounded-full px-6 py-3.5 text-sm font-semibold text-center"
              >
                See How It Works
              </a>
            </div>
            ...
            <div className="flex flex-wrap gap-6">
              {[
                ...
                <div key={l} className="flex flex-col gap-0.5">
                  <span
                    className="display font-bold text-base"
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-8 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
          ...
          <div className="flex flex-wrap gap-5">
            {[
              ...
              <span
                key={t}
                className="display font-semibold text-sm opacity-80"
                style={{ color: "var(--color-ink-dim)" }}
              >
                {t}
              </span>
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-6 md:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-start mt-4">
            <Reveal>
              <h2 className="display font-bold text-2xl md:text-3xl mb-4">
                Stop wasting time searching.
              </h2>

              <p
                className="max-w-md text-[15px] mb-6"
                style={{ color: "var(--color-ink-dim)" }}
              >
                People spend hundreds of hours trying to find the right courses,
                tutorials, and learning paths — piecing together a plan from
                scattered blog posts and playlists. Launchpad builds everything
                automatically, so that time goes toward actually learning.
              </p>

              <div className="flex flex-col gap-3.5 max-w-md">
                {[
                  "No more piecing a plan together from scattered posts",
                  "No more guessing which course is actually worth your time",
                  "No more starting over every time your goal shifts",
                ].map((line) => (
            ...
            <Reveal>
              <Card className="p-5 m-5" style={{ boxShadow: "var(--shadow-card)" }}>
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <div
                    className="flex-1 rounded-md h-6 ml-2"
                    style={{
                      background: "var(--color-bg)",
                      border: "1px solid var(--color-line)",
                    }}
                ...
                {[
                  '"best way to learn UX design 2024"',
                  '"react roadmap for beginners"',
                  '"free courses vs paid — which one"',
                ].map((q) => (
                  <div
                    key={q}
                    className="flex items-center justify-between rounded-lg px-3.5 py-2.5 mb-2"
                ...
                >
                  <span
                    ...
                    style={{ color: "var(--color-success)" }}
                  >
                    Launchpad builds your roadmap instantly
                  </span>
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-6 md:px-8">
          <Reveal className="max-w-xl mb-10">
            ...
            <h2 className="display font-bold text-2xl md:text-3xl mt-4 mb-3">
              Meet your AI learning coach
            </h2>
            <p
              className="text-[15px]"
              style={{ color: "var(--color-ink-dim)" }}
            ...
            {AI_CAPABILITIES.map((c) => (
              <Reveal key={c.title}>
                <Card
                  ...
                  style={{
                    background:
                      "linear-gradient(160deg, var(--color-bg-elev), var(--color-bg-elev2))",
                  }}
                >
                  <div
                  ...
                  <h3 className="display font-semibold text-base mb-2">
                    {c.title}
                  </h3>
                  <p
                    className="text-sm"
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-6 md:px-8">
          <Reveal className="max-w-xl mb-10">
            ...
            <h2 className="display font-bold text-2xl md:text-3xl mt-4">
              Everything you're tracking, in one dashboard
            </h2>
            <p
              className="text-[15px] mt-3"
              style={{ color: "var(--color-ink-dim)" }}
            >
              Roadmap, progress, planner, and achievements — all in one
              workspace.
            </p>
          </Reveal>
          ...
          <Reveal>
            <Card
              ...
              style={{ boxShadow: "0 30px 80px -25px rgba(0,0,0,0.5)" }}
            >
              <div className="grid md:grid-cols-2 gap-5">
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-1.5 mt-2">
                    {[
                      "Complete wireframing exercise",
                      "Watch UI patterns course",
                  ...
                  <span
                    className="mono text-[10px] mt-4 block"
                    style={{ color: "var(--color-ink-dim)" }}
                  >
                    ACHIEVEMENTS
                  </span>
                  <div className="flex gap-2 mt-2">
                    {[
                      ...
                      <span
                        key={label}
                        className="inline-flex items-center gap-1 text-[10px] rounded-full px-2.5 py-1.5"
                        style={{
                          background:
...
<section className="py-16">
  <div className="max-w-6xl mx-auto px-6 md:px-8">
    ...
    <div className="grid md:grid-cols-[1fr_0.8fr] gap-10 md:gap-14 items-center mt-4">

      <Reveal>
        <h2 className="display font-bold text-2xl md:text-3xl mb-5">
          About Launchpad
        </h2>

        <p
          className="text-[15px] leading-7 mb-4"
          style={{ color: "var(--color-ink-dim)", textAlign: "justify" }}
        >
          Launchpad is an AI-powered career and learning platform designed
          to help students, professionals, and lifelong learners transform
          ambitious goals into structured action plans.
        </p>
        ...
        <p
          ...
          style={{ color: "var(--color-ink-dim)", textAlign: "justify" }}
        >
          Instead of spending weeks searching for courses, tutorials, and
          learning paths, users simply describe their goal. Launchpad
          analyzes it and generates a personalized roadmap tailored to their
          experience, available time, and learning preferences — combining
          planning, resources, daily tasks, and progress tracking into one
          workspace.
        </p>
      </Reveal>
      ...
      <Reveal>
        ...
        >
          {[
            { icon: Target, label: "Describe a goal in plain language" },
            { icon: Map, label: "Get a structured, milestone-based plan" },
            {
              icon: Repeat,
              label: "Follow it as a daily habit, not a one-off list",
            },
          ].map((row, i, arr) => (
            <div
              key={row.label}
              className="flex items-center gap-3.5 px-4 px-4 py-4"
              style={
                i < arr.length - 1
                  ? { borderBottom: "1px solid var(--color-line)" }
                  : {}
      ...
      <section id="how" className="py-16">
        <div className="max-w-6xl mx-auto px-6 md:px-8">
          <Reveal className="max-w-xl mb-10">
            ...
            <h2 className="display font-bold text-2xl md:text-3xl mt-4">
              Five steps from idea to outcome
            </h2>
          </Reveal>
          <div className="grid sm:grid-cols-2 gap-5">
            {STEPS.map((s, i) => (
              ...
              >
                <Card className="hover-card p-6 h-full flex gap-4">
                  <div
                  ...
                  <div>
                    <span
                      className="mono block text-xs mb-1 opacity-70"
                      style={{ color: "var(--color-ink-dim)" }}
                    >
                      STEP {i + 1}
                    </span>
                    <h3 className="display font-semibold text-base mb-1">
                      {s.title}
                    </h3>
                    <p
                      className="text-sm"
          ...
          <Reveal>
            ...
            >
              {STATS.map((s) => (
                <div key={s.label}>
                  <div
                    className="display font-bold text-3xl md:text-4xl mb-1"
                    style={{ color: "var(--color-primary)" }}
                  >
                    {s.value}
                  </div>
              ...
              <Reveal key={s.name}>
                <Card className="hover-card p-6 h-full">
                  ...
                  <p
                    ...
                    style={{ color: "var(--color-ink-dim)", minHeight: "60px" }}
                  >
                    "{s.quote}"
                  </p>
                ...
                {contactSent ? (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="btn-solid sm:col-span-2 rounded-full py-3.5 text-sm font-semibold"
                      style={
                        contactSending
              ...
              <Card className="p-7 h-full flex flex-col gap-5 justify-center">
                {[
                  { Icon: Mail, label: "Email", value: "mhamrah112@gmail.com" },
                  {
                    Icon: GithubIcon,
                    label: "GitHub",
                    value: "https://github.com/Maryam-Hamrah1",
                  },
                  {
                    Icon: LinkedinIcon,
                    label: "LinkedIn",
                    value:
                      "https://www.linkedin.com/in/maryam-hamrah-5187442ab",
                  },
      ...
      <section className="py-16 text-center">
        <div className="max-w-6xl mx-auto px-6 md:px-8">
          <Reveal>
            ...
            >
              <h2 className="display font-bold text-2xl md:text-3xl mb-3 relative">
              ...
              <Link
                to="/signUp"
                className="btn-solid inline-block rounded-full px-7 py-3.5 text-sm font-semibold relative"
              >
                Create Free Roadmap
              </Link>
            </div>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-8 mb-9">
            ...
            <div>
              ...
              {[
                ...
                {
                  label: "LinkedIn",
                  href: "https://www.linkedin.com/in/maryam-hamrah-5187442ab",
                },
              ].map((item) => (
                <a
                  key={item.label}
