...
function Sidebar() {
  return (
    <aside
      className="w-60 flex-shrink-0 hidden md:flex md:flex-col px-4 py-6"
      style={{ borderRight: "1px solid var(--color-line)" }}
    >
      <div
        className="flex items-center gap-2.5 font-bold text-[15px] px-2 mb-8"
...
<div className="flex flex-col lg:flex-row lg:items-center justify-between gap-5 mb-8">
  ...
  <div
    className="flex items-center gap-3 rounded-2xl px-5 h-14 flex-1 max-w-xl"
    style={{
      background: "var(--color-bg-elev)",
      border: "1px solid var(--color-line)",
